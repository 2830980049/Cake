                    ...
                    <div class="panel heading-border">
                        <div class="panel-body bg-light">
                            <div class="section row">
                                <div class="col-md-5"><img src="../../../download/images/1537289970651.jpg" width="300"></div>
                                <div class="col-md-5">
                                    <div class="section row">
                                        <div class="col-md-3"><b>名称</b></div>
                                        <div class="col-md-9">深艾尔</div>
                                    </div>
                                    <div class="section row">
                                        <div class="col-md-3"><b>所属分类</b></div>
                                        <div class="col-md-9">复古</div>
                                    </div>
                                    <div class="section row">
                                        <div class="col-md-3"><b>口味</b></div>
                                        <div class="col-md-9">奶油</div>
                                    </div>
                                    <div class="section row">
                                    ...
                                    <div class="section row">
                                        ...
                                        <div class="col-md-9">268.0</div>
                                    </div>
                                    <div class="section row">
                                        <div class="col-md-3"><b>重量</b></div>
                                        <div class="col-md-9">10.0</div>
                                    </div>
                                    <div class="section row">
                                    ...
                                    <div class="section row">
                                        ...
                                        <div class="col-md-9">帝国世涛、樱桃果酱、 修道院啤酒</div>
                                    </div>
                                </div>
                            </div>
